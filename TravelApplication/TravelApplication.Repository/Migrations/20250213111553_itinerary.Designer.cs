...
namespace TravelApplication.Repository.Migrations
{
    ...
    [Migration("20250213111553_itinerary")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelApplication.Domain.Domain.MainModels.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TravelApplication.Domain.Domain.MainModels.Itinerary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TravelApplication.Domain.Domain.MainModels.Booking", b =>
                {
                    ...
                    b.HasOne("TravelApplication.Domain.Identity.TravelApplicationUser", "User")
                        .WithMany("Bookings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TravelApplication.Domain.Domain.MainModels.Itinerary", b =>
                {
                    b.HasOne("TravelApplication.Domain.Domain.MainModels.Booking", "Booking")
                        .WithMany()
