...
public class ActivityService : IActivityService
{
    ...
    public async Task<ActivityDTO> GetActivityByIdAsync(Guid id) // Changed from int to Guid
    {
    ...
    public async Task DeleteActivityAsync(Guid id) // Changed from int to Guid
    {
